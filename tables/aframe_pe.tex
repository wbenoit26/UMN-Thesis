...
\small\begin{tabular}{!{\vrule width 1pt}lcccccc!{\vrule width 1pt}}
\toprule[1pt]
& Event & $\mathcal{M}_c^\mathrm{src} (M_\odot)$ & ${m}_1^\mathrm{src} (M_\odot)$ & ${m}_2^\mathrm{src} (M_\odot)$ & $D_L$ (Gpc) & $\chi_\mathrm{eff}$ \\
\midrule[1pt]
